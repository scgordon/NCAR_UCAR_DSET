...
{</xsl:text><xsl:text>"title":"ISO-1 for Data Discovery - Mandatory",</xsl:text><xsl:text>"code":"ISO-1_Discovery-Mandatory",</xsl:text><xsl:text>"description":"This spiral includes mandatory ISO 19115-1 attributes for data discovery. This list of attributes was obtained from table F.1 of the ISO 19115-1 Specification.",</xsl:text><xsl:text>"maximum":"6",</xsl:text><xsl:variable name="ISO-1_Discovery-Mandatory.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/summary)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contentMetadata/geospatialCoverage/grid)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/topic[@vocabulary=ISO])) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Mandatory.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Mandatory.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dsOverview/title)"></xsl:sequence><xsl:sequence select="count(/dsOverview/summary)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contentMetadata/geospatialCoverage/grid)"></xsl:sequence><xsl:sequence select="count(/dsOverview/topic[@vocabulary=ISO])"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Mandatory.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Bounding Box",</xsl:text><xsl:variable name="ISO-1_Discovery-Mandatory.itemExists.d1e4290" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contentMetadata/geospatialCoverage/grid)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Mandatory.itemExists.d1e4290)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Mandatory.itemCounts.d1e4290" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contentMetadata/geospatialCoverage/grid)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Mandatory.itemCounts.d1e4290)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Type",</xsl:text><xsl:variable name="ISO-1_Discovery-Conditional.itemExists.d1e5997" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contentMetadata/dataType)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Conditional.itemExists.d1e5997)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Conditional.itemCounts.d1e5997" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contentMetadata/dataType)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Conditional.itemCounts.d1e5997)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"ISO-1 for Data Discovery - Optional",</xsl:text><xsl:text>"code":"ISO-1_Discovery-Optional",</xsl:text><xsl:text>"description":"This spiral includes optional ISO 19115-1 attributes for data discovery. This list of attributes was obtained from table F.1 of the ISO 19115-1 Specification.",</xsl:text><xsl:text>"maximum":"11",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/variable | /dsOverview/keyword)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contentMetadata/temporal)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/@ID | /dsOverview/@ID | /dsOverview/doi)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contact)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contentMetadata/geospatialCoverage/grid/@xRes | /dsOverview/contentMetadata/geospatialCoverage/grid/@yRes)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contentMetadata/temporal)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/contentMetadata/levels)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dsOverview/referenceURL)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dsOverview/variable) + count(/dsOverview/keyword)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contentMetadata/temporal)"></xsl:sequence><xsl:sequence select="count(/dsOverview/@ID) + count(/dsOverview/@ID) + count(/dsOverview/doi)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contact)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contentMetadata/geospatialCoverage/grid/@xRes) + count(/dsOverview/contentMetadata/geospatialCoverage/grid/@yRes)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contentMetadata/temporal)"></xsl:sequence><xsl:sequence select="count(/dsOverview/contentMetadata/levels)"></xsl:sequence><xsl:sequence select="count(/dsOverview/referenceURL)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Identifier",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e2622" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/@ID | /dsOverview/@ID | /dsOverview/doi)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e2622)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e2622" as="xs:integer+"><xsl:sequence select="count(/dsOverview/@ID | /dsOverview/@ID | /dsOverview/doi)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e2622)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Contact",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e997" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contact)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e997)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e997" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contact)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e997)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Spatial Resolution",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e6052" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contentMetadata/geospatialCoverage/grid/@xRes | /dsOverview/contentMetadata/geospatialCoverage/grid/@yRes)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e6052)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e6052" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contentMetadata/geospatialCoverage/grid/@xRes | /dsOverview/contentMetadata/geospatialCoverage/grid/@yRes)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e6052)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e6108" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contentMetadata/temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e6108)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e6108" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contentMetadata/temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e6108)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/dsOverview/contentMetadata/temporal",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/dsOverview/contentMetadata/temporal)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Vertical Extent",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e6171" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/contentMetadata/levels)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e6171)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e6171" as="xs:integer+"><xsl:sequence select="count(/dsOverview/contentMetadata/levels)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e6171)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource on-line Link",</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemExists.d1e6227" as="xs:integer+"><xsl:sequence select="if(exists(/dsOverview/referenceURL)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemExists.d1e6227)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ISO-1_Discovery-Optional.itemCounts.d1e6227" as="xs:integer+"><xsl:sequence select="count(/dsOverview/referenceURL)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ISO-1_Discovery-Optional.itemCounts.d1e6227)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/dsOverview/referenceURL",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/dsOverview/referenceURL)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/dsOverview/referenceURL)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
